...
[NOTE]
====
This document relies on running PostgreSQL as a Docker service, however, if you are not following the `serverless-workflow-callback-quarkus` you can use your own PostgreSQL installation.
====
